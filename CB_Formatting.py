...
def returnWarning(warning):
    print(WARNING + "WARNING: " + ENDC + "\n" + WARNING + warning + ENDC)

def returnInfo(info):
    print(OKBLUE + "INFO: " + ENDC + "\n" + OKBLUE + info + ENDC)
...
def returnTwintInfo():
    print(f"""
    {OKBLUE}Here is how to format your variables for the twitter modules.{ENDC}

    {OKCYAN}    Variable             Type       Description{OKGREEN}
    --------------------------------------------
